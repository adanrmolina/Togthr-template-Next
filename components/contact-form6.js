                  ...
                  <span className="contact-form6-text20">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_nc9V4Y'),
                      }}
                    ></span>
                  </span>
                </Fragment>
                ...
                {props.heading1 ?? (
                  <Fragment>
                    <span className="contact-form6-text25">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_SSDbS5'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="contact-form6-text23">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_eCmFeP'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
                  ...
                  {props.email ?? (
                    <Fragment>
                      <span className="contact-form6-text21">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_xzC-PI'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.phone ?? (
                    <Fragment>
                      <span className="contact-form6-text26">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_lC9BJN'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.address ?? (
                    <Fragment>
                      <span className="contact-form6-text22">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_um-VCw'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
          ...
          <form className="contact-form6-form thq-flex-column">
            <div className="contact-form6-container1">
              <div className="contact-form6-input1">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_0avqXO'),
                    }}
                  ></span>
                </label>
                <input
              ...
              <div className="contact-form6-input2">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_F7fHTZ'),
                    }}
                  ></span>
                </label>
                <input
            ...
            <div className="contact-form6-container2">
              <div className="contact-form6-input3">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_-vBF-y'),
                    }}
                  ></span>
                </label>
                <input
              ...
              <div className="contact-form6-input4">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_czVbsq'),
                    }}
                  ></span>
                </label>
                <input
            ...
            <div className="contact-form6-container3">
              <div className="contact-form6-input5">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_U0jpMq'),
                    }}
                  ></span>
                </label>
                <select
                ...
                >
                  <option value="Option 1">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_4DziV_'),
                      }}
                    ></span>
                  </option>
                  <option value="Option 1">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_GhUca7'),
                      }}
                    ></span>
                  </option>
                  <option value="Option 2">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_BMoU78'),
                      }}
                    ></span>
                  </option>
                  <option value="Option 2">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_WnWRe8'),
                      }}
                    ></span>
                  </option>
                  <option value="Option 3">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_PU4jwx'),
                      }}
                    ></span>
                  </option>
                  <option value="Option 3">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_z0e99A'),
                      }}
                    ></span>
                  </option>
                </select>
            ...
            <div className="contact-form6-container4">
              <div className="contact-form6-input6">
                ...
                >
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_FX2heu'),
                    }}
                  ></span>
                </label>
                <textarea
            ...
            <div className="contact-form6-checkbox1">
              ...
              <label htmlFor="contact-form-6-check" className="thq-body-small">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('text_G2Dg1A'),
                  }}
                ></span>
              </label>
            </div>
                ...
                {props.action ?? (
                  <Fragment>
                    <span className="contact-form6-text24">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: translate.raw('text_KisOq-'),
                        }}
                      ></span>
                    </span>
                  </Fragment>
